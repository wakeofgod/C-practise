...
int DrogonSword::getBaseDamage()
{
	return this->baseDamage;
}
//暴击效果
int DrogonSword::getCrit()
{
...
//触发概率
bool DrogonSword::isTriggle(int rate)
{
	int num = rand() % 100 + 1;
	if (num < rate)
	{
